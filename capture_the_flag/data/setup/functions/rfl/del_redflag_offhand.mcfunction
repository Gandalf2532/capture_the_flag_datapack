...
execute as @e[type=armor_stand,tag=pointred] at @s run execute as @a[distance=..4,team=redTeam] run item replace entity @a[distance=..4,team=redTeam] weapon.offhand with air
